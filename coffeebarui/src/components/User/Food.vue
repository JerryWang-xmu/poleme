<template>
    ...
    <div class="menu_food">
        ...
        <el-drawer
            ...
            <el-input placeholder="请输入搜索内容" v-model="query" style="padding: 50px" suffix-icon="el-icon-search" @input="textChanged">
            </el-input>
            <el-row :gutter="40">
...
<script>
    export default {
        ...
        methods: {
            ...
            async textChanged() {
                const {data: res} = await this.$http.post("selectMenu?querystring="+this.query);//todo
                if (res.flag == "ok") {
